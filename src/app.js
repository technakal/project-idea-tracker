...
class Project {
  ...
  createDomItem() {
    return `
      <li><input type="checkbox" id="${this.id}" ${this.completed ? "checked" : ""}/><label for="${
      this.id
    }">${this.text}</label>      </li>`;
  }
...
class App {
  ...
  getProjectCount() {
    return this.projects[this.currentList].projects.length;
  }

  updateTotalCompleted() {
    this.totalCompleted = this.projects[this.currentList].calculateTotalCompleted();
  ...
  updateCategoryCompleted() {
    const categories = this.projects[this.currentList].getCategoryNames();
    categories.forEach(category => {
      document.querySelector(
        `#${category.split(" ").join("-")}Completed`
      ).innerHTML = `${this.projects[this.currentList].calculateCompletedByCategory(
        category
